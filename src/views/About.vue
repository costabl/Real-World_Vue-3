<template>
  <div class="about">
    ...
    <div id="personalization_slot3">Insert your 3rd Personalization here!</div>
  </div>
</template>

<script>
/*
 ** THIS VERSION OF LIFT.JS IS FOR ACQUIA LIFT VERSION 4
 */
window.AcquiaLift = {
  /*
  ...
  profile: {
    author: 'Bruno Costa',
    engagement_score: '10',
    page_type: 'headless vue app',
    post_id: '1',
    published_date: '1507914363',
    content_title: 'Headless Personalization',
    content_type: 'headless',
    content_section: 'app',
    content_keywords: 'headless',
    persona: 'Headless User',
    utm_name: '',
    utm_content: '',
    utm_medium: '',
    utm_referrer: '',
